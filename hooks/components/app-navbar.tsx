...
const menuData = [
  {
    ...
    items: [
      ...
      { title: "Mali Raporlar", url: "/finans/mali-raporlar", icon: BarChart3, description: "Detaylı mali raporlar" },
      { title: "Bütçe Takibi", url: "/finans/butce-takibi", icon: Target, description: "Bütçe planlama ve takip" },
    ],
  },
  {
    title: "Seans",
